...
class LoginApp(HydraHeadApp):
    ...
    def run(self) -> None:
        ...
        st.markdown(
            "<h1 style='text-align: center;'>Secure CoreCodeSchool Login</h1>",
    ...
    def _create_login_form(self, parent_container) -> Dict:
        ...
        parent_container.write("sample login -> marc & core")
    ...
    def _check_login(self, login_data) -> int:
        ...
        if login_data["username"] == "marc" and login_data["password"] == "core":
            return 1
        else:
            return 0
